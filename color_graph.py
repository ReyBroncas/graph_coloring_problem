...
def read_from_file():
    ...
    Function reads matrix from a file and forms a dictionary with all adjacent vertices.
...
def graph_color(v, vDict, depth=1, v_real=set(), color_c=False):
    """
    (int,dict) -> vDict
...
def color_graph(vertex_color_dict, adj_vertices_dict):
    ...
    Function gets two dictionaries: 1) dictinary of vertices with colors they should be colored in
...
def form_base_colored_dict(colored_dict_unmod):
    ...
    Function gets dictionary where [key] is a vertice, and [value] is list of [[adjacent vertices], [color of vertex], [info used for backtracking]],
    and splits it into two *clean* dictionaries.
    The idea of the function is to split a main dictionary to make it easier to form and print a graph.
    """
